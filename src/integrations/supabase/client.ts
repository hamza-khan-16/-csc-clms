...
function createSupabaseClient() {
  // On the server (SSR/Node), always read from process.env at runtime — never use
  // import.meta.env here, because Vite replaces those with build-time literals,
  // meaning the real Vercel env vars would be silently ignored.
